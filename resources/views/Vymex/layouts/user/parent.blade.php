...
<head>
	...
	<script>
		...
		loadCSS( "{{asset(Config('page-settings.capCSS'))}}", false, "all")
		loadCSS( "{{asset(Config('page-settings.sidebarCSS'))}}", false, "all")
		loadCSS( "{{asset(Config('page-settings.UserCSS'))}}", false, "all")
		@yield("base-styles")
	</script>
</head>
